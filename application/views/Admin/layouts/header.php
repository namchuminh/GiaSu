  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url(); ?>" class="brand-link">
      <img src="<?php echo base_url('public/admin/') ?>dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Quản Lý Gia Sư</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">THÔNG TIN GIA SƯ</li>
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('admin/gia-su/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh Sách</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('admin/gia-su/them/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('admin/lop-gia-su/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh Sách</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('admin/lop-gia-su/them/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
          ...
          <li class="nav-header">THÔNG TIN LỚP</li>
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('admin/lop-hoc/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh Sách</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('admin/lop-hoc/them/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('admin/mon-hoc/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh Sách</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('admin/mon-hoc/them/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('admin/vi-tri/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Danh Sách</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('admin/vi-tri/them/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Thêm Mới</p>
                </a>
              </li>
          ...
          <li class="nav-header">THÔNG TIN WEB</li>
          <li class="nav-item has-treeview">
