        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo $detail[0]['TenBoMon']; ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control tenchinh" id="ten" placeholder="Tên môn học" name="tenmonhoc" value="<?php echo $detail[0]['TenBoMon']; ?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
              ...
              <button class="btn btn-primary">Cập Nhật Môn Học</button>
            </form>
          </div>
        </div>
      </div><!-- /.container-fluid -->
