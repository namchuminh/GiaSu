        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/lop-hoc/'); ?>">Quản Lý Lớp Học</a></li>
              <li class="breadcrumb-item active"><?php echo $detail[0]['TenLopHoc']; ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control tenchinh" id="ten" placeholder="Tên lớp học" name="tenlophoc" value="<?php echo $detail[0]['TenLopHoc']; ?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
              ...
              <a class="btn btn-success" href="<?php echo base_url('admin/lop-hoc/'); ?>">Quay Lại</a>
              <button class="btn btn-primary">Cập Nhật Lớp Học</button>
            </form>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    $(document).ready(function(){
        $('#taoduongdan').click(function(){
            if($(".tenchinh").val() == ""){
	            ...
	            toastr.error('Vui lòng nhập tên lớp học!', 'Thất Bại');
            }else{
