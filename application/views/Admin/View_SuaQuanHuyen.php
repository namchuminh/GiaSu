        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo $detail[0]['TenQuanHuyen']; ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control tenchinh" id="ten" placeholder="Tên quận / huyện" name="tenquanhuyen" value="<?php echo $detail[0]['TenQuanHuyen']; ?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
              ...
              <a class="btn btn-success" href="<?php echo base_url('admin/vi-tri/'.$tinh[0]['MaTinhThanh'].'/xem/'); ?>">Quay Lại</a>
              <button class="btn btn-primary">Cập Nhật Quận / Huyện</button>
            </form>
          </div>
        </div>
      </div><!-- /.container-fluid -->
