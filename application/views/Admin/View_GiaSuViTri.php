        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/gia-su/'); ?>">Danh Sách Khu Vực</a></li>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $vitri[0]['TenTinhThanh']; ?>" disabled>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Quận / Huyện Giảng Dạy</label>
                    <div class="select2-purple">
                      <select class="select2" multiple="multiple" data-placeholder="Chọn quận / huyện giảng dạy" data-dropdown-css-class="select2-purple" style="width: 100%;" name="vitri[]">
                        <?php foreach ($quanhuyen as $key => $value): ?>
                          <?php if(count($this->Model_ViTri->getGiaSuViTri($detail[0]['MaGiaSu'],$value['MaQuanHuyen'])) >= 1){ ?>
