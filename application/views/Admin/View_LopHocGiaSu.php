...
<div class="content-wrapper" style="min-height: 1203.31px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Gia Sư: <?php echo $detail[0]['TenLopHoc']; ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/'); ?>">Trang Chủ</a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/lop-hoc/'); ?>">Quản Lý Lớp Học</a></li>
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/lop-hoc/'.$detail[0]['MaLopHoc'].'/sua/'); ?>"><?php echo $detail[0]['TenLopHoc']; ?></a></li>
              ...
              <div class="card-footer clearfix">
                ...
                <ul class="pagination pagination-sm m-0 float-right">
                	<?php for($i = 1; $i <= $totalPages; $i++){ ?>
                  		<li class="page-item"><a class="page-link" href="<?php echo base_url('admin/lop-hoc/'.$detail[0]['MaLopHoc'].'/gia-su/'.$i.'/trang/') ?>"><?php echo $i; ?></a></li>
                  	<?php } ?>      
                </ul>
              </div>
            </div>
