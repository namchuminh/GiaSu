        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><?php echo $detail[0]['TenTinhThanh']; ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="ten">Tên Tỉnh / Thành Phố</label>
                    <input type="text" class="form-control tenchinh" id="ten" placeholder="Tên tỉnh / thành phố" name="tentinh" value="<?php echo $detail[0]['TenTinhThanh']; ?>">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
              ...
              <button class="btn btn-primary">Cập Nhật Tỉnh / Thành Phố</button>
            </form>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    $(document).ready(function(){
        $('#taoduongdan').click(function(){
            if($(".tenchinh").val() == ""){
              ...
              toastr.error('Vui lòng nhập tên tỉnh / thành phố!', 'Thất Bại');
            }else{
