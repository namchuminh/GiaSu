        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url('admin/gia-su/'); ?>">Danh Sách Lớp Học</a></li>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="select2-purple">
                      <select class="select2" multiple="multiple" data-placeholder="Chọn lớp giảng dạy" data-dropdown-css-class="select2-purple" style="width: 100%;" name="lop[]">
                        <?php foreach ($lop as $key => $value): ?>
                          <?php if(count($this->Model_LopHoc->getGiaSuLopHoc($detail[0]['MaGiaSu'],$value['MaLopHoc'])) >= 1){ ?>
              ...
              <button class="btn btn-primary">Cập Nhật Lớp Giảng Dạy</button>
            </form>
          </div>
        </div>
      </div><!-- /.container-fluid -->
