                            ...
                            <div class="product">
                                ...
                                <div class="product_info">
                                    ...
                                    <div class="product_price">
                                        <ul>
                                            <li>Lớp học:  <?php echo $value['TenLopHoc']; ?></li>
                        ...
                        <ul class="pagination mt-3 justify-content-center pagination_style1">
                            <?php if(isset($slug)){ ?>
                                <?php for($i = 1; $i <= $totalPages; $i++){ ?>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url('lop-hoc/'.$slug.'/trang/'.$i.'/') ?>"><?php echo $i; ?></a></li>
                                <?php } ?>
                            <?php }else{ ?>
                                <?php for($i = 1; $i <= $totalPages; $i++){ ?>
                                    <li class="page-item"><a class="page-link" href="<?php echo base_url('lop-hoc/trang/'.$i.'/') ?>"><?php echo $i; ?></a></li>
                                <?php } ?>
                            <?php } ?>
                ...
                <div class="sidebar">
                    <div class="widget">
                        ...
                        <div class="search_form">
                            <form action="<?php echo base_url('lop-hoc/') ?>"> 
                                <input required class="form-control" name="s" placeholder="Nhập tên lớp học..." type="text">
